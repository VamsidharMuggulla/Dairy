...
public class Logon {
	...
	public String validate(Context context,String email,String password)
	{
		...
		if(!b)
		{
		 ...
		 try {
			 ...
			 HttpPost httppost = new HttpPost("http://vamsidhar.esy.es/usersDairy.php");
		 ...
		 String aadmin=new String("yes");
		 String noadmin=new String("no");
		//convert response to string
		 ...
		 String result = sb.toString();
		  ...
		  String[] email2=new String[jArray.length()];
			...
			String[] admin=new String[jArray.length()];
			
		  //JSONArray ar=new JSONArray(ob);
		  for(int i=0;i<jArray.length();i++)
		  {
			  JSONObject json_data = jArray.getJSONObject(i);
			  email2[i]=json_data.getString("parentname");
		      admin[i]=json_data.getString("admin");
			  password2[i]=json_data.getString("password");
